...
function Validator(target, schema, options) {
  ...
  Object.defineProperties(this, {target: {value: target || {}, configurable: true, enumerable: true, writable: true}, options: {value: options || {}, configurable: true, enumerable: false, writable: true}, targetedProps: {value: [], enumerable: true, configurable: true, enumerable: false, writable: true}, validatedProps: {value: [], enumerable: true, configurable: true, enumerable: false, writable: true}, schema: {value: schema || {}, configurable: true, enumerable: false, writable: true}, keys: {value: [], configurable: true, enumerable: false, writable: true}, errors: {value: [], configurable: true, enumerable: true, writable: true}, is_valid: {get: (function () {
